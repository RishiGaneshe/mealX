...
exports.createJwtToken= async (id, username, identifier, identifierType, authProvider, role )=>{
  try{
      return jwt.sign( { id, username, identifier, identifierType, authProvider, role}, secret, {expiresIn: '3h'})
  }catch(err){
